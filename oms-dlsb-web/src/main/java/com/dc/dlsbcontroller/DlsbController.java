...
public class DlsbController extends BaseController {
      ...
      * @return
      */
     @RequestMapping("/goDcConfigIndex.html")
     public ModelAndView goDcConfigIndex(){
          ModelAndView mv = new ModelAndView();
          mv.setViewName(DlsbEnum.PAGE_DLSB_DC_CONFIG_INDEX.getKey());
          return mv;
     }


     @RequestMapping("/findCfgData.do")
     @ResponseBody
     public JSONObject findCfgData(Integer page,Integer limit){
          JSONObject jsonObject = new JSONObject();

          PageInfo<DmeDrcDdrbCfg> pageInfo = dlsbRmClient.findCfgAll(page, limit);
